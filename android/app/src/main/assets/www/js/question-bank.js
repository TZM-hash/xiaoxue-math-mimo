(function () {
    ...
    const pointCurriculum = {
      ...
      "g3-perimeter": { term: "三上", unit: "长方形和正方形", stage: "当前核心", focus: "先分清周长是围一圈，再套长方形、正方形周长公式。", questionTypes: ["长方形周长", "正方形周长", "边长反推"] },
      ...
      "g4-area": { term: "三下复习/四上拓展", unit: "面积、公顷和平方千米", stage: "复习拓展", focus: "区分周长和面积，知道平方厘米、平方米、公顷、平方千米。", questionTypes: ["长正方形面积", "面积单位", "单位换算"] },
      ...
      "g6-circle": { term: "六上", unit: "圆", stage: "当前核心", focus: "分清半径、直径、周长和面积公式。", questionTypes: ["圆周长", "圆面积", "半径直径"] },
